        ...
        private void guna2GradientButton4_Click(object sender, EventArgs e)
        {
            ...
            switch (MessageBox.Show("Server 1 (DigitalOcean):Yes\nServer 2 (Azure):No", "Server Select", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
            {
                case DialogResult.Yes:
                    hosturl = SERVER1 + "Overwatch/";
                    break;

                case DialogResult.No:
                    hosturl = SERVER2 + "Overwatch/";
                    break;
            }
            var username = Environment.UserName;
            ...
            else
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            ...
                            catch
                            {
                                ...
                                guna2HtmlLabel1.Text = "Failed to start game";
                                ResetButtons(true);
                                back.Enabled = true;
                            }
                        }
                        catch
                        {
                            ...
                            guna2HtmlLabel1.Text = "Extractiing Failed.";
                            ResetButtons(true);
                            back.Enabled = true;
                        }
                    ...
                    catch
                    {
                        ...
                        guna2HtmlLabel1.Text = "Download Failed.";
                        ResetButtons(true);
                        back.Enabled = true;
                    }
                }
                catch
                {
                    ...
                    guna2HtmlLabel1.Text = "Directory Creation Failed.";
                    ResetButtons(true);
                    back.Enabled = true;
                }
            }
