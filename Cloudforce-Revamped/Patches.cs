...
namespace Cloudforce_Revamped
{
    public partial class Patches : Form
    {
        ...
        public bool extractDone;

        public async void File_Extracter(string zipPath, string extractPath)
        {
            try
            {
                await Task.Run(() =>
        ...
        public string SERVER1 = "http://188.166.135.171/Files/";
        public string SERVER2 = "http://20.19.208.131/Files/";
        ...
        private void guna2GradientButton4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                File_Downloader(hosturl + "Overwatch/data/casc/data/0000000015.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0000000015.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0000000016.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0000000016.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0000000017.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0000000017.idx");

                File_Downloader(hosturl + "Overwatch/data/casc/data/0100000013.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0100000013.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0100000014.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0100000014.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0100000015.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0100000015.idx");

                File_Downloader(hosturl + "Overwatch/data/casc/data/0200000015.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0200000015.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0200000016.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0200000016.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0200000017.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0200000017.idx");

                File_Downloader(hosturl + "Overwatch/data/casc/data/0300000014.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0300000014.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0300000015.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0300000015.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0300000016.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0300000016.idx");

                File_Downloader(hosturl + "Overwatch/data/casc/data/0400000011.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0400000011.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0400000012.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0400000012.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0400000013.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0400000013.idx");

                File_Downloader(hosturl + "Overwatch/data/casc/data/0500000013.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0500000013.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0500000014.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0500000014.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0500000015.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0500000015.idx");

                File_Downloader(hosturl + "Overwatch/data/casc/data/0600000014.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0600000014.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0600000015.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0600000015.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0600000016.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0600000016.idx");

                File_Downloader(hosturl + "Overwatch/data/casc/data/0700000014.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0700000014.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0700000015.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0700000015.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0700000016.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0700000016.idx");

                File_Downloader(hosturl + "Overwatch/data/casc/data/0800000013.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0800000013.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0800000014.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0800000014.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0800000015.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0800000015.idx");

                File_Downloader(hosturl + "Overwatch/data/casc/data/0900000013.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0900000013.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0900000014.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0900000014.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0900000015.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0900000015.idx");

                File_Downloader(hosturl + "Overwatch/data/casc/data/0a00000011.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0a00000011.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0a00000012.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0a00000012.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0a00000013.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0a00000013.idx");

                File_Downloader(hosturl + "Overwatch/data/casc/data/0b00000015.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0b00000015.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0b00000016.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0b00000016.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0b00000017.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0b00000017.idx");

                File_Downloader(hosturl + "Overwatch/data/casc/data/0c00000014.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0c00000014.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0c00000015.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0c00000015.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0c00000016.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0c00000016.idx");

                File_Downloader(hosturl + "Overwatch/data/casc/data/0d00000012.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0d00000012.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0d00000013.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0d00000013.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0d00000014.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0d00000014.idx");

                File_Downloader(hosturl + "Overwatch/data/casc/data/0e00000012.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0e00000012.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0e00000013.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0e00000013.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0e00000014.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0e00000014.idx");

                File_Downloader(hosturl + "Overwatch/data/casc/data/0f00000013.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0f00000013.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0f00000014.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0f00000014.idx");
                File_Downloader(hosturl + "Overwatch/data/casc/data/0f00000015.idx", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\0f00000015.idx");

                guna2HtmlLabel1.Text = "[-] Downloading: data.000";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.000", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.000");
                guna2HtmlLabel1.Text = "[-] Downloading: data.001";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.001", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.001");
                guna2HtmlLabel1.Text = "[-] Downloading: data.002";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.002", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.002");
                guna2HtmlLabel1.Text = "[-] Downloading: data.003";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.003", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.003");
                guna2HtmlLabel1.Text = "[-] Downloading: data.004";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.004", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.004");
                guna2HtmlLabel1.Text = "[-] Downloading: data.005";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.005", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.005");
                guna2HtmlLabel1.Text = "[-] Downloading: data.006";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.006", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.006");
                guna2HtmlLabel1.Text = "[-] Downloading: data.007";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.007", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.007");
                guna2HtmlLabel1.Text = "[-] Downloading: data.008";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.008", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.008");
                guna2HtmlLabel1.Text = "[-] Downloading: data.009";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.009", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.009");
                guna2HtmlLabel1.Text = "[-] Downloading: data.010";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.010", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.010");
                guna2HtmlLabel1.Text = "[-] Downloading: data.011";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.011", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.011");
                guna2HtmlLabel1.Text = "[-] Downloading: data.012";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.012", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.012");
                guna2HtmlLabel1.Text = "[-] Downloading: data.013";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.013", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.013");
                guna2HtmlLabel1.Text = "[-] Downloading: data.014";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.014", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.014");
                guna2HtmlLabel1.Text = "[-] Downloading: data.015";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.015", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.015");
                guna2HtmlLabel1.Text = "[-] Downloading: data.016";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.016", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.016");
                guna2HtmlLabel1.Text = "[-] Downloading: data.017";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.017", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.017");
                guna2HtmlLabel1.Text = "[-] Downloading: data.018";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.018", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.018");
                guna2HtmlLabel1.Text = "[-] Downloading: data.019";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.019", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.019");
                guna2HtmlLabel1.Text = "[-] Downloading: data.020";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.020", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.020");
                guna2HtmlLabel1.Text = "[-] Downloading: data.021";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.021", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.021");
                guna2HtmlLabel1.Text = "[-] Downloading: data.022";
                File_Downloader(hosturl + "Overwatch/data/casc/data/data.022", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.022");
                guna2HtmlLabel1.Text = "[-] Downloading: data.023";
                File_Downloader(hosturl + "Overwatch/data/casc/data/shmem", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\shmem");

                guna2HtmlLabel1.Text = "[-] Downloading and Extracting: indices Files (i will freeze be patient)";
                File_Downloader(hosturl + "Overwatch/indices.zip", $"C:\\users\\{username}\\downloads\\OverWatch\\indices.zip");
                ...
                File_Downloader(hosturl + "Overwatch/retail.zip", $"C:\\users\\{username}\\downloads\\OverWatch\\retail.zip");
                ZipFile.ExtractToDirectory($@"C:\users\{username}\downloads\OverWatch\retail.zip", $@"C:\users\{username}\downloads\OverWatch\_retail_");
                File_Downloader(hosturl + "Overwatch/.product.db", $"C:\\users\\{username}\\downloads\\OverWatch\\.product.db");
                File_Downloader(hosturl + "Overwatch/Launcher.db", $"C:\\users\\{username}\\downloads\\OverWatch\\Launcher.db");
                File_Downloader(hosturl + "Overwatch/.patch.result", $"C:\\users\\{username}\\downloads\\OverWatch\\.patch.result");
                File_Downloader(hosturl + "Overwatch/.build.info", $"C:\\users\\{username}\\downloads\\OverWatch\\.build.info");
                File_Downloader(hosturl + "Overwatch/Overwatch%20Launcher.exe", $"C:\\users\\{username}\\downloads\\OverWatch\\Overwatch Launcher.exe");
                ResetButtons(true);
                back.Enabled = true;
        ...
        private void guna2GradientButton3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Directory.CreateDirectory($"C:\\users\\{username}\\downloads\\OverWatch");
                File_Extracter($@"C:\users\{username}\downloads\OverWatch\Overwatch.zip", $@"C:\users\{username}\downloads\OverWatch\");
                File_Downloader(hosturl + "Overwatch/data/casc/dsata/data.000", $"C:\\users\\{username}\\downloads\\OverWatch\\data\\casc\\data\\data.000");
